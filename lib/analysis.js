...
A product manager or researcher has just run a discovery interview with a customer about their
v2 product's "{{MODULE_LABEL}}" module — this is not a sales call, and there is no demo or deal to
prepare for. The interviewer asks (in their own words, not necessarily verbatim) the same 11
standard questions on every call:
